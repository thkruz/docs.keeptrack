...
![Eglin Radar](../../../assets/find-a-sensor/eglin.png)

<Aside type="tip">
  The Sensor FOV button displays the field of view for the selected sensor. This can help you visualize which satellites are visible from that location. We will learn more about it later.
</Aside>
